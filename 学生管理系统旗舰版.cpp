...
void operate::input(void) //输入学生信息
{
    ...
    int n;
    cout<<endl;
    cout<<"[1]Input Now  [2]Input From a txt";
    cout<<endl;
    cin>>n;
    if(n==1)
    { 
        ...
        while (q != null)
        {
            if (q->ID == _id)
            {
                ...
                default:
                    ...
                    if(r==1)
                    {
                        ofstream openfile("C:\\Users\\Ryy\\Desktop\\work\\final\\Test.txt",ios::app);
...
void operate::Sort(void)
{
    ...
    ofstream Outfile("C:\\Users\\Ryy\\Desktop\\work\\final\\Test.txt",ios::app);
    if(n==1){
        cout<<endl;
...
void operate::Del(void)
{
    ...
    if (!q)
    {
        ...
        ofstream open("C:\\Users\\Ryy\\Desktop\\work\\final\\Test.txt",ios::app);
        open<<"\nYou delele a student's data successuflly.The student id is"<<a[i]<<endl;
...
int main()
{
    ...
    if ((b == "Ryy") || (b == "ryy"))
    {
        ...
        if (c == "000919")
        {
            ...
            cout << "                  *---------------------------------------------------*\n";
            cout << "                  *------------------*-Ultimate-*---------------------*\n";
            cout << "                  *-----------v4.4.0 Copyright By RoyRao--------------*\n";
        ...
        {
            cout<<"            Password Wrong,Please Check!";
            cout<<endl;
